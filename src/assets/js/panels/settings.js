...
class Settings {
    ...
    async initRam() {
        ...
        let ram = ramDatabase ? ramDatabase : { ramMin: "1.5", ramMax: "4.5" };
    ...
    async initJavaPath() {
        ...
        let javaPath = javaDatabase ? javaDatabase : 'Usar la versión de Java entregada con el Launcher';
        ...
        document.querySelector(".path-button-reset").addEventListener("click", () => {
            path.value = 'Usar la versión de Java entregada con el lanzador';
            file.value = '';
